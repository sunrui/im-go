...
const (
	GroupChat_Subscribe_FullMethodName = "/pkg.rpc.chat.group_chat.GroupChat/Subscribe"
)
...
var GroupChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.rpc.chat.group_chat.GroupChat",
	...
	Metadata: "pkg/rpc/chat/group_chat/group_chat.proto",
}
