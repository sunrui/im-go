...
const (
	GroupChat_Subscribe_FullMethodName = "/pkg.rpc.message.group_chat.GroupChat/Subscribe"
)
...
var GroupChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.rpc.message.group_chat.GroupChat",
	...
	Metadata: "pkg/rpc/message/group_chat/group_chat.proto",
}
