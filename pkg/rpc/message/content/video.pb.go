...
// 	protoc        v4.25.3
// source: pkg/rpc/message/content/video.proto
...
var (
	file_internal_rpc_message_content_video_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
	file_internal_rpc_message_content_video_proto_goTypes  = []interface{}{
		(*Video)(nil), // 0: pkg.rpc.message.content.Video
	}
)
