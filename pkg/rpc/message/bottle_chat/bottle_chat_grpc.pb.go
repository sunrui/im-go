...
const (
	BottleChat_Subscribe_FullMethodName = "/pkg.rpc.message.bottle_chat.BottleChat/Subscribe"
)
...
var BottleChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.rpc.message.bottle_chat.BottleChat",
	...
	Metadata: "pkg/rpc/message/bottle_chat/bottle_chat.proto",
}
