...
// 	protoc        v4.25.3
// source: pkg/rpc/message/bottle_chat/bottle_chat.proto
...
var (
	file_internal_rpc_message_bottle_chat_bottle_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_internal_rpc_message_bottle_chat_bottle_chat_proto_goTypes  = []interface{}{
		(*SubscribeRequest)(nil), // 0: pkg.rpc.message.bottle_chat.SubscribeRequest
		(*SubscribeReply)(nil),   // 1: pkg.rpc.message.bottle_chat.SubscribeReply
	}
)

var file_internal_rpc_message_bottle_chat_bottle_chat_proto_depIdxs = []int32{
	0, // 0: pkg.rpc.message.bottle_chat.BottleChat.Subscribe:input_type -> pkg.rpc.message.bottle_chat.SubscribeRequest
	1, // 1: pkg.rpc.message.bottle_chat.BottleChat.Subscribe:output_type -> pkg.rpc.message.bottle_chat.SubscribeReply
