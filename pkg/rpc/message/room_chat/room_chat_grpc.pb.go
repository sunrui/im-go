...
const (
	RoomChat_Subscribe_FullMethodName = "/pkg.rpc.message.room_chat.RoomChat/Subscribe"
)
...
var RoomChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.rpc.message.room_chat.RoomChat",
	...
	Metadata: "pkg/rpc/message/room_chat/room_chat.proto",
}
