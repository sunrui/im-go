...
const (
	P2PChat_Subscribe_FullMethodName = "/pkg.rpc.message.p2p_chat.P2pChat/Subscribe"
)
...
var P2PChat_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.rpc.message.p2p_chat.P2pChat",
	...
	Metadata: "pkg/rpc/message/p2p_chat/p2p_chat.proto",
}
