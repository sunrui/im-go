...
// 	protoc        v4.25.3
// source: pkg/rpc/message/chat/chat.proto
...
import (
	...
	content "pkg/rpc/message/content"
)
...
type ToReply struct {
	...
	Status     ToReply_Status `protobuf:"varint,3,opt,name=status,proto3,enum=pkg.rpc.message.chat.ToReply_Status" json:"status,omitempty"` // 状态
...
var (
	file_internal_rpc_message_chat_chat_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_internal_rpc_message_chat_chat_proto_msgTypes  = make([]protoimpl.MessageInfo, 5)
	file_internal_rpc_message_chat_chat_proto_goTypes   = []interface{}{
		(ToReply_Status)(0),       // 0: pkg.rpc.message.chat.ToReply.Status
		(*Content)(nil),           // 1: pkg.rpc.message.chat.Content
		(*ToRequest)(nil),         // 2: pkg.rpc.message.chat.ToRequest
		(*ToReply)(nil),           // 3: pkg.rpc.message.chat.ToReply
		(*SubscribeRequest)(nil),  // 4: pkg.rpc.message.chat.SubscribeRequest
		(*SubscribeReply)(nil),    // 5: pkg.rpc.message.chat.SubscribeReply
		(*content.Text)(nil),      // 6: pkg.rpc.message.content.Text
		(*content.Sticker)(nil),   // 7: pkg.rpc.message.content.Sticker
		(*content.Quoted)(nil),    // 8: pkg.rpc.message.content.Quoted
		(*content.Image)(nil),     // 9: pkg.rpc.message.content.Image
		(*content.Audio)(nil),     // 10: pkg.rpc.message.content.Audio
		(*content.Video)(nil),     // 11: pkg.rpc.message.content.Video
		(*content.File)(nil),      // 12: pkg.rpc.message.content.File
		(*content.Location)(nil),  // 13: pkg.rpc.message.content.Location
		(*content.Card)(nil),      // 14: pkg.rpc.message.content.Card
		(*content.Withdraw)(nil),  // 15: pkg.rpc.message.content.Withdraw
		(*content.Voice)(nil),     // 16: pkg.rpc.message.content.Voice
		(*content.VoiceCall)(nil), // 17: pkg.rpc.message.content.VoiceCall
		(*content.VideoCall)(nil), // 18: pkg.rpc.message.content.VideoCall
		(*Source)(nil),            // 19: pkg.rpc.message.chat.Source
	}
)

var file_internal_rpc_message_chat_chat_proto_depIdxs = []int32{
	6,  // 0: pkg.rpc.message.chat.Content.text:type_name -> pkg.rpc.message.content.Text
	7,  // 1: pkg.rpc.message.chat.Content.sticker:type_name -> pkg.rpc.message.content.Sticker
	8,  // 2: pkg.rpc.message.chat.Content.quoted:type_name -> pkg.rpc.message.content.Quoted
	9,  // 3: pkg.rpc.message.chat.Content.image:type_name -> pkg.rpc.message.content.Image
	10, // 4: pkg.rpc.message.chat.Content.audio:type_name -> pkg.rpc.message.content.Audio
	11, // 5: pkg.rpc.message.chat.Content.video:type_name -> pkg.rpc.message.content.Video
	12, // 6: pkg.rpc.message.chat.Content.file:type_name -> pkg.rpc.message.content.File
	13, // 7: pkg.rpc.message.chat.Content.location:type_name -> pkg.rpc.message.content.Location
	14, // 8: pkg.rpc.message.chat.Content.card:type_name -> pkg.rpc.message.content.Card
	15, // 9: pkg.rpc.message.chat.Content.withdraw:type_name -> pkg.rpc.message.content.Withdraw
	16, // 10: pkg.rpc.message.chat.Content.voice:type_name -> pkg.rpc.message.content.Voice
	17, // 11: pkg.rpc.message.chat.Content.voiceCall:type_name -> pkg.rpc.message.content.VoiceCall
	18, // 12: pkg.rpc.message.chat.Content.videoCall:type_name -> pkg.rpc.message.content.VideoCall
	19, // 13: pkg.rpc.message.chat.ToRequest.source:type_name -> pkg.rpc.message.chat.Source
	1,  // 14: pkg.rpc.message.chat.ToRequest.content:type_name -> pkg.rpc.message.chat.Content
	0,  // 15: pkg.rpc.message.chat.ToReply.status:type_name -> pkg.rpc.message.chat.ToReply.Status
	19, // 16: pkg.rpc.message.chat.SubscribeReply.source:type_name -> pkg.rpc.message.chat.Source
	1,  // 17: pkg.rpc.message.chat.SubscribeReply.content:type_name -> pkg.rpc.message.chat.Content
	2,  // 18: pkg.rpc.message.chat.Chat.To:input_type -> pkg.rpc.message.chat.ToRequest
	4,  // 19: pkg.rpc.message.chat.Chat.Subscribe:input_type -> pkg.rpc.message.chat.SubscribeRequest
	3,  // 20: pkg.rpc.message.chat.Chat.To:output_type -> pkg.rpc.message.chat.ToReply
	5,  // 21: pkg.rpc.message.chat.Chat.Subscribe:output_type -> pkg.rpc.message.chat.SubscribeReply
