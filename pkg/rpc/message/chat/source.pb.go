...
// 	protoc        v4.25.3
// source: pkg/rpc/message/chat/source.proto
...
var (
	file_internal_rpc_message_chat_source_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
	file_internal_rpc_message_chat_source_proto_goTypes  = []interface{}{
		(*Source)(nil), // 0: pkg.rpc.message.chat.Source
	}
)
