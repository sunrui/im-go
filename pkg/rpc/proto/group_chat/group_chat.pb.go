...
var (
	file_pkg_rpc_chat_group_chat_group_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_pkg_rpc_chat_group_chat_group_chat_proto_goTypes  = []interface{}{
		(*SubscribeRequest)(nil), // 0: pkg.test.proto.group_chat.SubscribeRequest
		(*SubscribeReply)(nil),   // 1: pkg.test.proto.group_chat.SubscribeReply
		(*Online)(nil),           // 2: pkg.test.proto.group_chat.Online
		(*Offline)(nil),          // 3: pkg.test.proto.group_chat.Offline
		(*Join)(nil),             // 4: pkg.test.proto.group_chat.Join
		(*Leave)(nil),            // 5: pkg.test.proto.group_chat.Leave
		(*Mute)(nil),             // 6: pkg.test.proto.group_chat.Mute
		(*Unmute)(nil),           // 7: pkg.test.proto.group_chat.Unmute
	}
)

var file_pkg_rpc_chat_group_chat_group_chat_proto_depIdxs = []int32{
	2, // 0: pkg.test.proto.group_chat.SubscribeReply.online:type_name -> pkg.test.proto.group_chat.Online
	3, // 1: pkg.test.proto.group_chat.SubscribeReply.offline:type_name -> pkg.test.proto.group_chat.Offline
	4, // 2: pkg.test.proto.group_chat.SubscribeReply.join:type_name -> pkg.test.proto.group_chat.Join
	5, // 3: pkg.test.proto.group_chat.SubscribeReply.leave:type_name -> pkg.test.proto.group_chat.Leave
	6, // 4: pkg.test.proto.group_chat.SubscribeReply.mute:type_name -> pkg.test.proto.group_chat.Mute
	7, // 5: pkg.test.proto.group_chat.SubscribeReply.unmute:type_name -> pkg.test.proto.group_chat.Unmute
	0, // 6: pkg.test.proto.group_chat.GroupChat.Subscribe:input_type -> pkg.test.proto.group_chat.SubscribeRequest
	1, // 7: pkg.test.proto.group_chat.GroupChat.Subscribe:output_type -> pkg.test.proto.group_chat.SubscribeReply
