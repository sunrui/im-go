...
var (
	file_pkg_rpc_chat_p2p_chat_p2p_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
	file_pkg_rpc_chat_p2p_chat_p2p_chat_proto_goTypes  = []interface{}{
		(*SubscribeRequest)(nil), // 0: pkg.test.proto.p2p_chat.SubscribeRequest
		(*SubscribeReply)(nil),   // 1: pkg.test.proto.p2p_chat.SubscribeReply
		(*Online)(nil),           // 2: pkg.test.proto.p2p_chat.Online
		(*Offline)(nil),          // 3: pkg.test.proto.p2p_chat.Offline
		(*Inputting)(nil),        // 4: pkg.test.proto.p2p_chat.Inputting
		(*InputStop)(nil),        // 5: pkg.test.proto.p2p_chat.InputStop
		(*MessageDelivered)(nil), // 6: pkg.test.proto.p2p_chat.MessageDelivered
		(*MessageRead)(nil),      // 7: pkg.test.proto.p2p_chat.MessageRead
		(*MessageReject)(nil),    // 8: pkg.test.proto.p2p_chat.MessageReject
		(*MessageWithdraw)(nil),  // 9: pkg.test.proto.p2p_chat.MessageWithdraw
		(*FriendRequest)(nil),    // 10: pkg.test.proto.p2p_chat.FriendRequest
		(*FriendReply)(nil),      // 11: pkg.test.proto.p2p_chat.FriendReply
	}
)

var file_pkg_rpc_chat_p2p_chat_p2p_chat_proto_depIdxs = []int32{
	2,  // 0: pkg.test.proto.p2p_chat.SubscribeReply.online:type_name -> pkg.test.proto.p2p_chat.Online
	3,  // 1: pkg.test.proto.p2p_chat.SubscribeReply.offline:type_name -> pkg.test.proto.p2p_chat.Offline
	4,  // 2: pkg.test.proto.p2p_chat.SubscribeReply.inputting:type_name -> pkg.test.proto.p2p_chat.Inputting
	5,  // 3: pkg.test.proto.p2p_chat.SubscribeReply.inputStop:type_name -> pkg.test.proto.p2p_chat.InputStop
	6,  // 4: pkg.test.proto.p2p_chat.SubscribeReply.messageDelivered:type_name -> pkg.test.proto.p2p_chat.MessageDelivered
	7,  // 5: pkg.test.proto.p2p_chat.SubscribeReply.messageRead:type_name -> pkg.test.proto.p2p_chat.MessageRead
	8,  // 6: pkg.test.proto.p2p_chat.SubscribeReply.messageReject:type_name -> pkg.test.proto.p2p_chat.MessageReject
	9,  // 7: pkg.test.proto.p2p_chat.SubscribeReply.messageWithdraw:type_name -> pkg.test.proto.p2p_chat.MessageWithdraw
	10, // 8: pkg.test.proto.p2p_chat.SubscribeReply.friendRequest:type_name -> pkg.test.proto.p2p_chat.FriendRequest
	11, // 9: pkg.test.proto.p2p_chat.SubscribeReply.friendReply:type_name -> pkg.test.proto.p2p_chat.FriendReply
	0,  // 10: pkg.test.proto.p2p_chat.P2pChat.Subscribe:input_type -> pkg.test.proto.p2p_chat.SubscribeRequest
	1,  // 11: pkg.test.proto.p2p_chat.P2pChat.Subscribe:output_type -> pkg.test.proto.p2p_chat.SubscribeReply
