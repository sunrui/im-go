...
var file_internal_rpc_message_group_chat_group_chat_proto_goTypes = []interface{}{
	(*SubscribeRequest)(nil), // 0: internal.rpc.message.group_chat.SubscribeRequest
	(*SubscribeReply)(nil),   // 1: internal.rpc.message.group_chat.SubscribeReply
...
var file_internal_rpc_message_group_chat_group_chat_proto_depIdxs = []int32{
	2, // 0: internal.rpc.message.group_chat.SubscribeReply.online:type_name -> internal.rpc.message.group_chat.Online
	3, // 1: internal.rpc.message.group_chat.SubscribeReply.offline:type_name -> internal.rpc.message.group_chat.Offline
	4, // 2: internal.rpc.message.group_chat.SubscribeReply.join:type_name -> internal.rpc.message.group_chat.Join
	5, // 3: internal.rpc.message.group_chat.SubscribeReply.leave:type_name -> internal.rpc.message.group_chat.Leave
	6, // 4: internal.rpc.message.group_chat.SubscribeReply.mute:type_name -> internal.rpc.message.group_chat.Mute
	7, // 5: internal.rpc.message.group_chat.SubscribeReply.unmute:type_name -> internal.rpc.message.group_chat.Unmute
	0, // 6: internal.rpc.message.group_chat.GroupChat.Subscribe:input_type -> internal.rpc.message.group_chat.SubscribeRequest
	1, // 7: internal.rpc.message.group_chat.GroupChat.Subscribe:output_type -> internal.rpc.message.group_chat.SubscribeReply
